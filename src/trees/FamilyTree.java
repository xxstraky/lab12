...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("There are either no children in this line, or it is malformed."); //?? throw a TreeException with a useful message
		...
		else
		{
			...
			if (parentNode == null) throw new TreeException(line + "\nParent of this line could not be found; the input file is malformed.");
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) throw new TreeException("Node with " + name1 + " not found, invalid input");
			// ??? Throw a TreeException with a useful message
		TreeNode node2 = root.getNodeWithName(name2); //???		// node whose name is name2
		if (node2 == null) throw new TreeException("Node with " + name2 + " not found, invalid input");
